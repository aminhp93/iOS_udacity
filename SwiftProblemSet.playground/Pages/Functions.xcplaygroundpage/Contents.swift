...
func emojiLove(/* add parameters here */s1:String, s2:String) {
 ...
 */
func beginsWithVowel(/* add parameters here */input: String) /* define the return type */ -> Bool {
    /* add function implementation here */
    
    if input != "" {
        let lowercase_input = input.lowercased().characters[input.startIndex]
...
var input = "MINH"
input.lowercased().characters[input.startIndex]

 
 beginsWithVowel(input: "Apples") // true
 beginsWithVowel(input: "pIG") // false
 beginsWithVowel(input: "oink") // true
 beginsWithVowel(input: "udacity") // true
 beginsWithVowel(input: "") // false
 ...
 */
func funWithWords(/* add parameters here */input:String) /* define the return type */ ->String{
    /* add function implementation here */
    if input == ""{
        return input
    } else {
        let first_char = input.characters[input.startIndex]
 ...
 funWithWords(input: "Apples") // "APPLES"
 funWithWords(input: "pIG") // "pig"
 funWithWords(input: "oink") // "OINK"
 funWithWords(input: "udacity") // "UDACITY"
 funWithWords(input: "") // ""
