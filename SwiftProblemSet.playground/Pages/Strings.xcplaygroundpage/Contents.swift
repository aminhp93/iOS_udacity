...
let lottaLikes_removeLike = lottaLikes.replacingOccurrences(of: "like", with: "")
...
weeklyEarningsString.replacingOccurrences(of: "X", with: "\(averageRent*100/averageMonthlyEarnings)")
/*:
 ****
 [Table of Contents](Table%20of%20Contents) | [Previous](@previous) | [Next](@next)
 */
